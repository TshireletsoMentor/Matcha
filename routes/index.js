      ...
      if(session.username != 'admin'){
        ...
        connection.query(sql1, [
          ...
          if(ret1[0].extProfComp == 1){
            ...
            const sql2 = "SELECT COUNT(*) AS count FROM users WHERE username NOT IN (?, ?) AND suspended != 1";
            connection.query(sql2, [
              'admin',
              session.username
            ], (err, count) => {
              ...
              const sql3 = "SELECT * FROM users WHERE username NOT IN (?, ?) AND suspended != 1 ORDER BY RAND() LIMIT ?, ?";
              connection.query(sql3, [
                'admin',
                session.username, 
